...
The mod tracks when you have cleared a chunk or POI of zombies and prevents them from respawning in that chunk.
...
You can use the following sandbox settings as a starting point and tweak them further:
Keep in mind that trader quests, for example, reset a POI, meaning all the zombies within that POI will reappear.
